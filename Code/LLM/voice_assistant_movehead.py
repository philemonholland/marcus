...
conversation = [
    {
        ...
        "content": (
            ...
            "  \"personnalité\": \"Cynique, morbide, sarcastique, vulgaire, et doté d’un humour noir tranchant comme une guillotine mal entretenue\",\n"
...
async def main():
    ...
    try:
        ...
        welcome_prompts = [
            "Présentes-toi et proposes tes services."
        ]
